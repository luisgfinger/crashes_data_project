...
class DummyPath:
    """Path fake só para suportar / e f-strings de print."""
...
def test_run_dry_run_skips_writes_and_applies_transforms(monkeypatch, capsys):
    calls = {
        "assert_cols": 0,
        "normalize": 0,
        "dq_df": None,
...
def test_run_non_dry_run_calls_writes_with_expected_paths(monkeypatch):
    writes = {
        "clean": None,
        "quarantine": None,
        "metrics": None,
    ...
    assert writes["metrics"]["path"] == "/metrics/crashes/v1/full/run_date=2026-03-03"
